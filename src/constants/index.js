...
export const ABOUT_TEXT = `I am a Technology Lead and Full-Stack Developer with over 4 years of experience specializing in Angular (Advanced), .NET Core, and Node.js. My expertise lies in architecting scalable enterprise-grade applications and high-performance data platforms that drive business efficiency.

Currently leading engineering at HooLiv, I specialize in designing complex REST APIs and interactive analytics dashboards using Chart.js and ApexCharts. I have a proven track record of managing cross-functional teams of up to 10 developers, delivering mission-critical solutions like Project Cost Management and Fleet Management systems.
