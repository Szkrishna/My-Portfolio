...
const Navbar = () => {
  return (
    <nav className="marker:mb-20 flex items-center justify-between py-8 lg:px-[80px]"
      style={{ "position": "fixed", "background": "rgb(34, 34, 34)", "minWidth": "-webkit-fill-available", "zIndex": "2" }}>
      <div className="flex flex-shrink-0 items-center">
        ...
        <div className="ml-8 my-4 flex items-center justify-center gap-5 text-2xl text-white">
