...
const About = () => {
    return (
        <div className="border-b border-neutral-300 pb-4 px-4 md:px-8 lg:px-12 xl:px-16">
            ...
            <div className="flex flex-wrap lg:px-[120px] pb-[80px] justify-between max-w-[1200px] mx-auto">
                <motion.div whileInView={{ opacity: 1, x: 0 }} initial={{ opacity: 0, x: -100 }} transition={{ duration: 0.5 }} className="w-full lg:w-1/2">
                    <div className="flex items-center justify-center lg:justify-start">
                        <img className="rounded-2xl max-h-[420px] ps-2" src={aboutImg} alt="about-img" />
                    </div>
                </motion.div>
                <motion.div whileInView={{ opacity: 1, x: 0 }} initial={{ opacity: 0, x: 100 }} transition={{ duration: 0.5 }} className="w-full lg:w-1/2">
                    <div className="flex justify-center lg:justify-start">
                        ...
                        <motion.p variants={{ hidden: { opacity: 0, y: 50 }, visible: { opacity: 1, y: 0, transition: { duration: 1.5, delay: 1 } }, }}
                            initial="hidden" animate="visible" className="max-w-2xl font-light text-md tracking-wide">
                            {ABOUT_TEXT}
                        </motion.p>
                    </div>
                </motion.div>
