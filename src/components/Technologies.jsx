    ...
    return (
        <div className="border-b border-neutral-300 pb-24">
            ...
            <motion.div whileInView={{opacity: 1, x: 0}} initial={{opacity: 0, x: -100}} transition={{duration: 1.5}} className="flex flex-wrap items-center justify-center gap-4">
                ...
                <Tooltip id="react" place="top" content="React" style={{ fontSize: "28px" }} />
                ...
                <Tooltip id="angular" place="top" content="Angular" style={{ fontSize: "28px" }} />
                ...
                <Tooltip id="node" place="top" content="Node.js" style={{ fontSize: "28px" }} />
                ...
                <Tooltip id="python" place="top" content="Python" style={{ fontSize: "28px" }} />
                ...
                <Tooltip id="mysql" place="top" content="MySQL" style={{ fontSize: "28px" }} />
                ...
                <Tooltip id="mongodb" place="top" content="MongoDB" style={{ fontSize: "28px" }} />
            </motion.div>
        </div>
    )
}
