    ...
    return (
        <div className="border-b border-neutral-300 lg:mt-[40px] px-4 md:px-8 lg:px-12 xl:px-16">
            <div className="flex flex-wrap lg:py-[100px] lg:px-[120px] pt-[160px] pb-[80px] justify-between max-w-[1200px] mx-auto">
                ...
                <div className="w-full xl:w-1/2 max-w-2xl flex flex-col items-center xl:items-end">
                    <div className="flex justify-center">
                        <motion.img initial={{ x: 100, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 1.5, delay: 1.5 }} className="rounded-2xl max-h-[350px]" src={profilePic} alt="ks-profile-img" />
                    </div>
                </div>
            </div>
        </div>
